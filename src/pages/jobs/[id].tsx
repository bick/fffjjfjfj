...
export default function JobPost({ job }) {
  ...
  const handleApplyClick = () => {
    if (
      ...
      job.apply_link.startsWith("https://")
    ) {
  ...
  return (
    <section className={styles.pageContainer}>
      <Layout>
        <Head>
          <title>
            {job.job_title} at {job.company_name} - Startup Jobs Italia
          </title>
          <meta
            name="description"
            content={`${job.job_title} job opportunity at ${job.company_name}. ${job.summary}`}
          />
          ...
          <div className={styles.sectionOne}>
            <div>
              ...
              <div className={styles.dateInfoCont}>
                <h2 className={styles.companyName}>@ {job.company_name}</h2>
            ...
            <div className={styles.tags}>
              ...
              <p className={styles.tag}>
                {job.tag_one ? "#" + job.tag_one : ""}
              </p>
              <p className={styles.tag}>
                {job.tag_two ? "#" + job.tag_two : ""}
              </p>
              <p className={styles.tag}>
                {job.tag_three ? "#" + job.tag_three : ""}
              </p>
            </div>
          </div>
          <div className={styles.sectionTwo}>
            <button className={styles.applyCTA} onClick={handleApplyClick}>
              Apply
            </button>
          </div>
        </section>
